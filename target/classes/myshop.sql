...
CREATE TABLE QNA_COMMENT(
		QCID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
		QID INT,
		MID INT,
		REF INT,
		QNA_COMMENT VARCHAR(1000),
		MEMBER_ID VARCHAR(50),
		QNA_COMMENT_CREATED DATETIME DEFAULT NOW(),
		QNA_COMMENT_DELYN VARCHAR(10) DEFAULT 'N'
	)ENGINE = INNODB DEFAULT CHARSET=UTF8
...
CREATE TABLE QNABOARD( 
	...
	QNA_COMMENTNY VARCHAR(10) DEFAULT 'N',
...
INSERT INTO SPOON_MEMBER (MEMBER_ID,MEMBER_EMAIL,MEMBER_PASSWORD,MEMBER_ADMINYN) VALUES ("admin","km94sm@icloud.com","1234","Y")
